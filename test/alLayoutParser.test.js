      ...
      const alContent = `report 50101 AnotherReport
{
    RDLCLayout = "src/layouts/AnotherReport.rdl";
      ...
      assert.deepStrictEqual(
        layouts,
        [{ label: "RDLC Layout", path: "src/layouts/AnotherReport.rdl" }],
        "Test Case 2 Failed"
      );
    });
      ...
      const alContent = `report 50102 WordReport
{
    ...
    WordLayout = 'src/layouts/WordReport.docx';
      ...
      assert.deepStrictEqual(
        layouts,
        [{ label: "Word Layout", path: "src/layouts/WordReport.docx" }],
        "Test Case 3 Failed"
      );
    });
      ...
      const alContent = `report 50106 SpacedReport
{
    RDLCLayout   =   'src/layouts/SpacedReport.rdl' ;
      ...
      assert.deepStrictEqual(
        layouts,
        [{ label: "RDLC Layout", path: "src/layouts/SpacedReport.rdl" }],
        "Test Case 7 Failed"
      );
    });
      ...
      const alContent = `report 50107 CommentedReport
{
    ...
    WordLayout = 'src/layouts/Actual.docx';
      ...
      assert.deepStrictEqual(
        layouts,
        [{ label: "Word Layout", path: "src/layouts/Actual.docx" }],
        "Test Case 8 Failed"
      );
    });
      ...
      const alContent = `report 50108 CommentedReportBlock
{
    ...
    */
    ExcelLayout = 'src/layouts/RealLayout.xlsx';
      ...
      assert.deepStrictEqual(
        layouts,
        [{ label: "Excel Layout", path: "src/layouts/RealLayout.xlsx" }],
        "Test Case 9 Failed"
      );
    });
      ...
      const alContent = `table 50100 MyTable
{
    ...
    // RDLCLayout = 'src/layouts/TableReport.rdl'; // This would be ignored
      ...
      assert.deepStrictEqual(
        layouts,
        [],
        "Test Case New-A Failed: Incorrect object type"
      );
    });
      ...
      const alContent = `This is not a valid AL object.
{
    RDLCLayout = 'src/layouts/InvalidObject.rdl';
      ...
      assert.deepStrictEqual(
        layouts,
        [],
        "Test Case New-B Failed: Invalid object definition"
      );
    });

    it("should find layouts in rendering block (newer syntax)", () => {
      const alContent = `report 50100 "Test Report"
{
    rendering
    {
        layout(RDLCLayout)
      ...
      assert.deepStrictEqual(
        ...
        [
          {
            label: "Test RDLC Layout (RDLCLayout)",
            path: "._Base\report\terwet.rdl",
          },
          {
            label: "Test Word Layout (WordLayout)",
            path: "_Base\report\terwet.docx",
          },
        ],
        "Test Case Rendering Block Failed"
      );
    });

    it("should find layouts in rendering block without captions", () => {
      const alContent = `report 50101 "Simple Report"
{
    rendering
    {
        layout(MyRDLC)
      ...
      assert.deepStrictEqual(
        layouts,
        [{ label: "Layout: MyRDLC", path: "layouts/simple.rdl" }],
        "Test Case Rendering Block No Caption Failed"
      );
    });
  });
      ...
      const alContent = `reportextension 50100 MyReportExt extends MyReport
{
    rendering
    {
      ...
      assert.deepStrictEqual(
        ...
        [
          {
            label: "My Custom RDLC Layout (MyCustomLayout)",
            path: "src/layouts/MyCustomLayout.rdl",
          },
        ],
        "Test Case 11 Failed"
      );
      ...
      const alContent = `reportextension 50101 MultiLayoutExt extends AnotherReport
{
    rendering
    {
      ...
      assert.deepStrictEqual(
        ...
        [
          {
            label: "Standard RDLC (RDLC Layout)",
            path: "src/layouts/ExtReport1.rdl",
          },
      ...
      const alContent = `reportextension 50102 NoCaptionExt extends ReportX
{
    rendering
    {
      ...
      assert.deepStrictEqual(
        ...
        [
          {
            label: "Layout: SimpleLayout",
            path: "src/layouts/SimpleExcel.xlsx",
          },
        ],
        "Test Case 13 Failed"
      );
      ...
      const alContent = `reportextension 50105 QuoteMixExt extends ReportQ
{
    rendering
    {
      ...
      assert.deepStrictEqual(
        ...
        [
          {
            label: "Mixed Quotes 1 (DoubleQuoteName)",
            path: "src/layouts/DoubleNameSinglePath.rdl",
          },
          {
            label: "Mixed Quotes 2 (SingleQuoteName)",
            path: "src/layouts/SingleNameDoublePath.docx",
          },
        ],
        "Test Case 16 Failed"
      );
      ...
      const alContent = `reportextension 50106 SpacedExt extends ReportS
{
    rendering
    {
      ...
      assert.deepStrictEqual(
        ...
        [
          {
            label: "Spaced Out Caption (SpacedLayoutName)",
            path: "src/layouts/SpacedLayout.rdl",
          },
        ],
        "Test Case 17 Failed"
      );
      ...
      const alContent = `reportextension 50108 CommentedLayoutExt extends ReportCL
{
    rendering
    {
      ...
      assert.deepStrictEqual(
        ...
        [
          {
            label: "This one is visible (VisibleLayout)",
            path: "src/layouts/Visible.rdl",
          },
        ],
        "Test Case 19 Failed"
      );
      ...
      const alContent = `pageextension 50100 MyPageExt extends MyPage
{
    ...
    // rendering { layout('Hidden') { LayoutFile = 'test.rdl'; } } // This would be ignored
      ...
      assert.deepStrictEqual(
        layouts,
        [],
        "Test Case New-C Failed: Incorrect object type"
      );
    });
      ...
      const alContent = `This is not a valid AL object for reportextension.
{
    rendering { layout('A') { LayoutFile = 'invalid.rdl'; } }
      ...
      assert.deepStrictEqual(
        layouts,
        [],
        "Test Case New-D Failed: Invalid object definition"
      );
    });
  });
...
try {
  ...
  if (allTests.includes("assert.")) {
    // Basic check
    console.log(
      "Tests defined. In a real environment, a test runner would execute them."
    );
    console.log(
      "Simulating test execution: If no 'AssertionError' appears below, basic checks passed."
    );
